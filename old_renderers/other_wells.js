...
Renderers.other_wells = {
  pickle: function (al) {
    delete al.legend_url;
    al.leaflet_layer_ids = [];
    delete al.parameters.all_statii;
    delete al.parameters.all_types;
  ...
  create_leaflet_layers: function (map, active_layer) {
    ...
    if (!active_leaflet_layer) {
      ...
      Renderers.wells.load_well_data(function (well_type) { return !well_type.match(/oil/i) && !well_type.match(/gas/i); }, ingest);
    }
  },
  ...
  render: function (map, active_layer, z_index) {
    Renderers.other_wells.create_leaflet_layers(map, active_layer);
    //Renderers.other_wells.update_legend(map, active_layer);
