Renderers.wtrcls_line = {
  ...
  update_legend_url: function (active_layer) {
    ...
    active_layer.legend_url_text = "DEC classified waters (click for info)";
  },
  ...
  get_feature_info_url: function (active_layer) {
    return CDN(MAP_SERVER_HOST + "/geoserver/nyccsc/wms" +
          ...
          "REQUEST=GetFeatureInfo&LAYERS=nyccsc:wtrcls_line&"+
          "QUERY_LAYERS=nyccsc:wtrcls_line&"+
          "STYLES=&"+
          "BBOX=<%= bbox %>&"+
          "FEATURE_COUNT=5&"+
          "HEIGHT=<%= height %>&"+
