...
Renderers.oil_wells = {
  ...
  create_leaflet_layers: function (map, active_layer) {
    ...
    if (!active_leaflet_layer) {
      ...
      Renderers.wells.load_well_data(function (well_type) { return well_type.match(/oil/i); }, ingest);
    }
  },
  ...
  render: function (map, active_layer, z_index) {
    Renderers.oil_wells.create_leaflet_layers(map, active_layer);
