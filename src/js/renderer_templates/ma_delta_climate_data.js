RendererTemplates.ma_delta_climate_data = function (layer_id, opts) {
  RendererTemplates.ma_climate_data(layer_id, {
    ...
    info_template: `
        ...
        <div class='col-xs-3'>
          Projected change in {{active_layer.parameters.all_seasons[active_layer.parameters.options.season]}} {{{active_layer.parameters.all_metrics[active_layer.parameters.options.metric]}}}, 2000-{{active_layer.parameters.years[active_layer.parameters.options.year_indx]}} 
        </div>

        <div class='col-xs-1'>
          {{geojson.data_value}} {{active_layer.parameters.info_legend}}
        </div>
    `,
    legend_template: `
