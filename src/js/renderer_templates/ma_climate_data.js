...
RendererTemplates.ma_climate_data = function (layer_id, opts) {
  let geometries = {
    ...
    "county": "https://geoserver.nescaum-ccsc-dataservices.com/geoserver/ma/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ma:county_boundary&maxFeatures=1000&outputFormat=application%2Fjson",
    "state": "https://geoserver.nescaum-ccsc-dataservices.com/geoserver/ma/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ma:state_boundary&maxFeatures=1000&outputFormat=application%2Fjson",
    ...
    "basin": "https://geoserver.nescaum-ccsc-dataservices.com/geoserver/ma/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ma:basins&maxFeatures=1000&outputFormat=application%2Fjson"
    //"6km": "" ,
  }
