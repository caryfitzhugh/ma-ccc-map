RendererTemplates.ma_climate_data('ma_historical_temperature', {
  clone_layer_name: function(active_layer) {
    let p = active_layer.parameters.options;
    var name =  "MA Historical Temps " + p.metric + " Y:" + active_layer.parameters.years[p.year_indx] + " S:" + p.season + " by " + p.summary;
    return name;
  },
  legend_template: `
