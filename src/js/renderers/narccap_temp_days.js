...
Renderers.narccap_temp_days = {
  ...
  find_geo_json: function (map, active_layer, evt) {
    ...
    var active_svg_layer = Renderers.narccap_temp_days.active_leaflet_layer(map, active_layer);
  ...
  create_leaflet_layers: function (map, active_layer) {
    ...
    var active_leaflet_layer = Renderers.narccap_temp_days.active_leaflet_layer(map, active_layer);
          ...
          if (error) {
            ...
            GeometryLoader.load(p.area, function (error, geometries) {
              if (error) {
                ...
                active_leaflet_layer = Renderers.narccap_temp_days.active_leaflet_layer(map, active_layer);
  ...
  render: function (map, active_layer, z_index) {
    ...
    Renderers.narccap_temp_days.create_leaflet_layers(map, active_layer);
    Renderers.narccap_temp_days.update_legend(map, active_layer);
