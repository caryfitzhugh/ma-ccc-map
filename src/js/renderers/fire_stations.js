RendererTemplates.wms("fire_stations", {
  ...
  legend_template: `
      <div class='detail-block show-confidence'>
        <label> Legend: </label>
        <img src='{{CDN("http://giswebservices.massgis.state.ma.us/geoserver/wms?request=GetLegendGraphic&LAYER=massgis:GISDATA.FIRESTATIONS_PT_MEMA&format=image/png")}}'/>
      </div>
  `,
  info_template: `
      <div class='col-xs-2'>
