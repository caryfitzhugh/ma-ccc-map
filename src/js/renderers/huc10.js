...
/*    min_zoom: 12,
  ...
  wms_opts:(active_layer) => {
    ...
    return  {
      layers: 'massgis:GISDATA.NRCSHUC10_POLY',
      format: "image/png",
      opacity: 0,
      zIndex: -1,
      transparent: true,
  ...
  legend_template: `
      <div class='detail-block show-confidence'>
        <label> Legend: </label>
        <img src='{{CDN("http://giswebservices.massgis.state.ma.us/geoserver/wms?request=GetLegendGraphic&LAYER=massgis:GISDATA.NRCSHUC10_POLY&format=image/png")}}'/>
      </div>
  `,
  info_template: `
      <div class='col-xs-2'>
