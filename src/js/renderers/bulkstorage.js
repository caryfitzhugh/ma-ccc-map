...
Renderers.bulkstorage = {
  ...
  update_legend_url: function (active_layer) {
    ...
    active_layer.legend_url_text = "Click on the map for more info";
  },
  ...
  get_feature_info_url: function (active_layer) {
    return CDN(MAP_SERVER_HOST + "/geoserver/nyccsc/wms" +
          ...
          "REQUEST=GetFeatureInfo&LAYERS=nyccsc:bulkstorage&"+
          "QUERY_LAYERS=nyccsc:bulkstorage&"+
          "STYLES=&"+
          "BBOX=<%= bbox %>&"+
          "FEATURE_COUNT=5&"+
          "HEIGHT=<%= height %>&"+
