RendererTemplates.wms("gas_providers", {
  parameters: {
    opacity: 70,
/*    min_zoom: 14,
    max_zoom: 20,*/
  ...
  wms_opts:(active_layer) => {
    ...
    return  {
      layers: 'massgis:GISDATA.TOWNS_POLY_V_GAS',
      format: "image/png",
      opacity: 0,
      zIndex: -1,
      transparent: true,
  ...
  legend_template: `
      <div class='detail-block show-confidence'>
        <label> Legend: </label>
        <img src='{{CDN("http://giswebservices.massgis.state.ma.us/geoserver/wms?request=GetLegendGraphic&LAYER=massgis:GISDATA.TOWNS_POLY_V_GAS&format=image/png")}}'/>
      </div>
  `,
  info_template: `
      <div class='col-xs-2'>
