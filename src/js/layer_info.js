...
/*  {
  ...
  },
  {
    ...
    "sectors": ["Agriculture","Forestry","Coastal Zone","Economy","Energy","Local Government","Natural Resources/Habitats","Public Health","Public Safety/Emergency Response","Recreation","Infrastructure","Water Resources"],
    "description": "Projected changes in annual or seasonal total precipitation, summarized by county, drainage basin, or the entire state, for two different Representative Concentration Pathways (RCPs).  RCP 4.5 is part of a medium-emissions scenario with a reduction in greenhouse gas emissions so that radiative forcing stabilizes at 4.5 W/m2 before the end of this century.  RCP 8.5 is part of a high-emission scenario where emissions continue to increase over time, and radiative forcing reaches 8.5 W/m2 before the end of this century.   Changes are relative to the 1971-2000 mean, calculated for four periods centered around 2035 (2020-2049), 2055 (2040-2069), 2075 (2060-2089), and 2090 (2080-2099). The projections are derived from statistically downscaled (LOCA method) CMIP5 daily data. Data Source: Statistically downscaled CMIP5 daily Climate Observations using Localized Constructed Analogs (LOCA; Pierce et al., 2014).",
    "source": "University of California San Diego",
    "source_url": "http://loca.ucsd.edu/",
  ...
  },
  {
    ...
    "sectors": ["Agriculture","Forestry","Coastal Zone","Economy","Energy","Local Government","Natural Resources/Habitats","Public Health","Public Safety/Emergency Response","Recreation","Infrastructure","Water Resources"],
    "description": "Consecutuve dry days (no measureable precipitation) summarized by area (state,county,basin) and decade over the period 1960-2005. Observational dataset: Livneh et al. (2015). <br>Data Source: Statistically downscaled CMIP5 daily Climate Observations using Localized Constructed Analogs (LOCA; Pierce et al., 2014), Observational data: A spatially comprehensive, meteorological data set for Mexico, the U.S., and southern Canada (Livneh et al., 2015)",
    "source": "University of California San Diego",
    "source_url": "http://loca.ucsd.edu/",
    //"download_url": "https://repository.nescaum-ccsc-dataservices.com/data/ma/temperature.json",
    "metadata_url": "http://loca.ucsd.edu/"
  ...
  },
  {
    ...
    "sectors": ["Agriculture","Forestry","Coastal Zone","Economy","Energy","Local Government","Natural Resources/Habitats","Public Health","Public Safety/Emergency Response","Recreation","Infrastructure","Water Resources"],
    "description": "Projected changes in annual or seasonal average temperature, summarized by county, drainage basin, or the entire state, for two different Representative Concentration Pathways (RCPs).  RCP 4.5 is part of a medium-emissions scenario with a reduction in greenhouse gas emissions so that radiative forcing stabilizes at 4.5 W/m2 before the end of this century.  RCP 8.5 is part of a high-emission scenario where emissions continue to increase over time, and radiative forcing reaches 8.5 W/m2 before the end of this century.   Changes are relative to the 1971-2000 mean, calculated for four periods centered around 2035 (2020-2049), 2055 (2040-2069), 2075 (2060-2089), and 2090 (2080-2099). The projections are derived from statistically downscaled (LOCA method) CMIP5 daily data. Data Source: Statistically downscaled CMIP5 daily Climate Observations using Localized Constructed Analogs (LOCA; Pierce et al., 2014).",
    "source": "University of California San Diego",
    "source_url": "http://loca.ucsd.edu/",
  ...
  },
  {
    ...
    "sectors": ["Agriculture","Forestry","Coastal Zone","Economy","Energy","Local Government","Natural Resources/Habitats","Public Health","Public Safety/Emergency Response","Recreation","Infrastructure","Water Resources"],
    "description": "Projected changes in annual or seasonal mean heating degree-days, summarized by county, drainage basin, or the entire state, for two different Representative Concentration Pathways (RCPs).  Heating degree-days are based on the assumption that when the outside temperature is above 65°F, we don't need heating to be comfortable. Heating degree days are the difference between the daily temperature mean and 65°F. For example, if the mean temperature mean is 25°F, we subtract the mean from 65 and the result is 40 heating degree-days for that day. (Definition adapted from National Weather Service)<br>Emissions scenarios: RCP 4.5 is part of a medium-emissions scenario with a reduction in greenhouse gas emissions so that radiative forcing stabilizes at 4.5 W/m2 before the end of this century.  RCP 8.5 is part of a high-emission scenario where emissions continue to increase over time, and radiative forcing reaches 8.5 W/m2 before the end of this century.<br>Projected changes are relative to the 1971-2000 mean, calculated for four periods centered around 2035 (2020-2049), 2055 (2040-2069), 2075 (2060-2089), and 2090 (2080-2099). The projections are derived from statistically downscaled (LOCA method) CMIP5 daily data. Data Source: Statistically downscaled CMIP5 daily Climate Observations using Localized Constructed Analogs (LOCA; Pierce et al., 2014).",
    "source": "University of California San Diego",
    "source_url": "http://loca.ucsd.edu/",
  ...
  },
  {
    ...
    "sectors": ["Agriculture","Forestry","Coastal Zone","Economy","Energy","Local Government","Natural Resources/Habitats","Public Health","Public Safety/Emergency Response","Recreation","Infrastructure","Water Resources"],
    "description": "Projected changes in annual or seasonal mean cooling degree-days, summarized by county, drainage basin, or the entire state, for two different Representative Concentration Pathways (RCPs).   Cooling degree days are based on the assumption that when the outside temperature is below 65°F, we don't need cooling (air-conditioning) to be comfortable. Cooling degree-days are the difference between the daily temperature mean and 65°F. For example, if the temperature mean is 85°F, we subtract 65 from the mean and the result is 20 cooling degree-days for that day. (Definition adapted from National Weather Service).<br>Emissions scenarios: RCP 4.5 is part of a medium-emissions scenario with a reduction in greenhouse gas emissions so that radiative forcing stabilizes at 4.5 W/m2 before the end of this century.  RCP 8.5 is part of a high-emission scenario where emissions continue to increase over time, and radiative forcing reaches 8.5 W/m2 before the end of this century. <br>Projected changes are relative to the 1971-2000 mean, calculated for four periods centered around 2035 (2020-2049), 2055 (2040-2069), 2075 (2060-2089), and 2090 (2080-2099). The projections are derived from statistically downscaled (LOCA method) CMIP5 daily data. Data Source: Statistically downscaled CMIP5 daily Climate Observations using Localized Constructed Analogs (LOCA; Pierce et al., 2014).",
    "source": "University of California San Diego",
    "source_url": "http://loca.ucsd.edu/",
  ...
  },
  {
    ...
    "sectors": ["Agriculture","Forestry","Coastal Zone","Economy","Energy","Local Government","Natural Resources/Habitats","Public Health","Public Safety/Emergency Response","Recreation","Infrastructure","Water Resources"],
    "description": "Projected changes in annual or seasonal mean growing degree-days, summarized by county, drainage basin, or the entire state, for two different Representative Concentration Pathways (RCPs).  A growing degree day (GDD) is an index used to express crop maturity. The index is computed by subtracting a base temperature of 50°F from the average of the maximum and minimum temperatures for the day. Minimum temperatures less than 50°F are set to 50, and maximum temperatures greater than 86°F are set to 86. These substitutions indicate that no appreciable growth is detected with temperatures lower than 50° or greater than 86°. (Definition adapted from National Weather Service) <br>Emissions scenarios: RCP 4.5 is part of a medium-emissions scenario with a reduction in greenhouse gas emissions so that radiative forcing stabilizes at 4.5 W/m2 before the end of this century.  RCP 8.5 is part of a high-emission scenario where emissions continue to increase over time, and radiative forcing reaches 8.5 W/m2 before the end of this century.<br>Projected changes are relative to the 1971-2000 mean, calculated for four periods centered around 2035 (2020-2049), 2055 (2040-2069), 2075 (2060-2089), and 2090 (2080-2099). The projections are derived from statistically downscaled (LOCA method) CMIP5 daily data. Data Source: Statistically downscaled CMIP5 daily Climate Observations using Localized Constructed Analogs (LOCA; Pierce et al., 2014).",
    "source": "University of California San Diego",
    "source_url": "http://loca.ucsd.edu/",
...
/*  {
  ...
  /*
  {
    ...
    "folder": "Water Resources",
    "name": "Hydrology",
    "description":" Hydrological projections are provided for stream gage locations.",
    "source": "University of Massachusetts – Amherst",
    "source_url": "",
    "sectors": ["Agriculture","Forestry","Coastal Zone","Economy","Local Government","Natural Resources/Habitats","Public Health","Public Safety/Emergency Response","Recreation","Infrastructure","Water Resources"],
    "download_url": "",
  ...
  */
  ...
  },
  {
    ...
    "folder": "Public Safety/Emergency Response",
    "name": "Schools",
    "description": "This point datalayer shows the locations of schools in Massachusetts. Sample of Schools Data Schools appearing in this layer are those attended by students in pre-kindergarten through high school, based on the Massachusetts Department of Elementary and Secondary Education (ESE) school profiles database as of October 20, 2015. Categories of schools include public, private, charter, and approved and unapproved special education.",
    "source": "MassGIS",
    "source_url": "http://www.mass.gov/anf/research-and-tech/it-serv-and-support/application-serv/office-of-geographic-information-massgis/",
    "sectors": ["Public Health","Public Safety/Emergency Response","Infrastructure"],
  ...
  },
  {
    ...
    "description": "<p>A subset of the \'Land Use (2005)\' datalayer, this layer includes only areas classified as cranberry bog, orchard, nursery, crop land or pasture. </p><p> The Land Use (2005) datalayer is a Massachusetts statewide, seamless digital dataset of land cover / land use, created using semi-automated methods, and based on 0.5 meter resolution digital ortho imagery captured in April 2005.</p>",
    "source": "MassGIS",
    "source_url": "http://www.mass.gov/anf/research-and-tech/it-serv-and-support/application-serv/office-of-geographic-information-massgis/",
    "sectors": ["Agriculture","Forestry","Coastal Zone","Economy","Local Government","Natural Resources/Habitats","Water Resources"],
    "download_url": "http://www.mass.gov/anf/research-and-tech/it-serv-and-support/application-serv/office-of-geographic-information-massgis/datalayers/ftplus2005.html",
