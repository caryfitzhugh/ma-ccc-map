...
var LayerInfo = [
    ...
    },
    {
      ...
      "folder": "Water Resources",
      "name": "VT Groundwater",
      "description": " 1. Groundwater  Class II Areas Groundwater Class II Area. This GIS layer consists of the geographic location of the Groundwater Class II Areas for active and proposed Public Community groundwater withdrawal areas labeled by the Water System Identification Number (WSID) and source number (i.e. WL001). The Class II area locations are drawn from the State Drinking Water database (SDWIS). The water sources are wells and springs that exist or are proposed for Public Community Water Supply development.  Groundwater Class II area boundaries have been located on RF 24000 & RF 25000 scale USGS topographic maps by Drinking Water and Groundwater Protection Division (DEC) personnel. Buffered Class II areas are based on the point location of the water source(s) if existing. Refer to the SOURCE coverage documentation file for information on data sources used.  <br/> <br/> 2. Groundwater Class IV Areas Groundwater Class IV Area. This GIS layer consists of the geographic location of the Groundwater Class IV Areas which delineates groundwater contaminated above the drinking water standards for one or more constituents caused by a human related activity.  This groundwater is unsuitable for drinking water withdrawal, but may be suitable for certain non-drinking agricultural and industrial and commercial uses. The Class IV area locations are drawn from the State Drinking Water database (SDWIS). The ground water is not suitable for either Public or Non-Public water supply development.  Groundwater Class IV area boundaries have been located on RF 24000 & RF 25000 scale USGS topographic maps by Drinking Water and Groundwater Protection Division (DEC) or the Waste Management and Prevention Division (DEC) personnel.  Refer to the SOURCE coverage documentation file for information on data sources used.",
      "source": "VT ANR Open Data",
      "parameters": {
        "opacity": 70,
      }
